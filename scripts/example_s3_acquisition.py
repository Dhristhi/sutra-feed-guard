...
# ///
"""Example: Download from S3 and run Feed Guard classification.
...
def main() -> int:
    if len(sys.argv) < 3:
        print("Usage: python example_s3_acquisition.py <s3_uri> <policy.yaml>")
        print("Example: python example_s3_acquisition.py s3://bucket/data.json policy.yaml")
        return 1
